...
if &background == "light"
    ...
    hi Normal ctermbg=Black ctermfg=LightGray guibg=#000000 guifg=#c5c5c5 gui=none
    ...
    hi StatusLine ctermbg=LightGray ctermfg=Black guibg=#4d5793 guifg=#ffffff gui=none
    hi StatusLineNC ctermbg=LightGray ctermfg=Black guibg=#707070 guifg=#ffffff gui=none
    if has("spell")
    ...
    hi TabLine guibg=#4a4a4a guifg=#dadada gui=underline
    hi TabLineFill guibg=#4a4a4a guifg=#dadada gui=underline
    hi TabLineSel guibg=bg guifg=fg gui=bold
    hi Title ctermbg=bg ctermfg=White guifg=fg gui=bold
    hi VertSplit ctermbg=LightGray ctermfg=Black guibg=#707070 guifg=#ffffff gui=none
    if version >= 700
